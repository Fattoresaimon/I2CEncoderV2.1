...
/* Gamma register */
extern volatile uint8_t GAMMAGP1; //address 
extern volatile uint8_t GAMMAGP2; //address 
extern volatile uint8_t GAMMAGP3_RLED; //address 
extern volatile uint8_t GAMMAGLED; //address 
extern volatile uint8_t GAMMABLED; //address 

extern volatile uint8_t GCONF2; //address 
...
extern volatile bool S_CKSRC, S_RELATIVE;
